...
export const ALL_REQUESTS: Request[] = [
  { id: 'BMOC-2024-0045', title: 'New Waterproofing Compound WP-250',   customer: 'Internal', type: 'Create New Product',   site: 'INPL001', requestor: 'Priya Sharma',  date: '10 Jun 2026', stage: 'Pre Approval',  status: 'In Progress', amount: 'Rs.2,40,000', priority: 'P2' },
  { id: 'BMOC-2024-0044', title: 'RM Update Cellulose Ether CF-5',      customer: 'Internal', type: 'Raw Material Update',  site: 'INPL004', requestor: 'Rahul Verma',   date: '08 Jun 2026', stage: 'Approvals',     status: 'In Progress', amount: 'Rs.85,000',   priority: 'P1' },
  { id: 'BMOC-2024-0043', title: 'Product Ext Admixture AD-20 Mumbai',  customer: 'Internal', type: 'Product Extension',    site: 'INPL003', requestor: 'Anjali Mehta',  date: '05 Jun 2026', stage: 'Post Approval', status: 'Approved',    amount: 'Rs.1,20,000', priority: 'P3' },
  { id: 'BMOC-2024-0042', title: 'Packaging Change SikaBond T55',       customer: 'Internal', type: 'Product Update',       site: 'INPL001', requestor: 'Vikram Singh',  date: '01 Jun 2026', stage: '—',             status: 'Draft',       amount: 'Rs.50,000',   priority: 'P3' },
  { id: 'BMOC-2024-0041', title: 'Deactivation ThermoPlast TP Legacy',  customer: 'Internal', type: 'Product Deactivation', site: 'INPL002', requestor: 'Priya Sharma',  date: '28 May 2026', stage: 'Approvals',     status: 'Rejected',    amount: '—',           priority: 'P2' },
  { id: 'BMOC-2024-0040', title: 'New RM Polypropylene Fiber PF-100',   customer: 'Internal', type: 'New Raw Material',     site: 'INPL005', requestor: 'Rahul Verma',   date: '25 May 2026', stage: 'Post Approval', status: 'Approved',    amount: 'Rs.3,60,000', priority: 'P2' },
  { id: 'BMOC-2024-0039', title: 'Product Ext CureX C-30 Kolkata',      customer: 'Internal', type: 'Product Extension',    site: 'INPL007', requestor: 'Anjali Mehta',  date: '22 May 2026', stage: 'Approvals',     status: 'In Progress', amount: 'Rs.95,000',   priority: 'P1' },
  { id: 'BMOC-2024-0038', title: 'RM Update Silica Fume SF-10',         customer: 'Internal', type: 'Raw Material Update',  site: 'INPL002', requestor: 'Priya Sharma',  date: '18 May 2026', stage: '—',             status: 'Approved',    amount: 'Rs.40,000',   priority: 'P3' },
  { id: 'BMOC-2024-0037', title: 'New Product FlexiSeal FS-500',        customer: 'Internal', type: 'Create New Product',   site: 'INPL001', requestor: 'Vikram Singh',  date: '15 May 2026', stage: 'Pre Approval',  status: 'On Hold',     amount: 'Rs.4,80,000', priority: 'P2' },
  { id: 'BMOC-2024-0036', title: 'New Packaging HDPE Drum 200L',        customer: 'Internal', type: 'New Packaging',        site: 'INPL004', requestor: 'Rahul Verma',   date: '12 May 2026', stage: 'Pre Approval',  status: 'Submitted',   amount: 'Rs.1,50,000', priority: 'P1' },
  { id: 'BMOC-2024-0035', title: 'Product Update GraniCrete GC-10',     customer: 'Internal', type: 'Product Update',       site: 'INPL003', requestor: 'Anjali Mehta',  date: '08 May 2026', stage: 'Pre Approval',  status: 'Returned',    amount: 'Rs.2,00,000', priority: 'P2' },
  { id: 'BMOC-2024-0034', title: 'New RM Titanium Dioxide TiO2-25',     customer: 'Internal', type: 'New Raw Material',     site: 'INPL001', requestor: 'Priya Sharma',  date: '02 May 2026', stage: '—',             status: 'Completed',   amount: 'Rs.5,00,000', priority: 'P3' },
  { id: 'BMOC-2024-0033', title: 'Product Ext HydroProof HP-20 Hyd',    customer: 'Internal', type: 'Product Extension',    site: 'INPL006', requestor: 'Rohit Kumar',   date: '28 Apr 2026', stage: 'Pre Approval',  status: 'In Progress', amount: 'Rs.1,10,000', priority: 'P1' },
  { id: 'BMOC-2024-0032', title: 'Packaging Update PET Bottle 1L',      customer: 'Internal', type: 'Packaging Update',     site: 'INPL001', requestor: 'Priya Sharma',  date: '24 Apr 2026', stage: '—',             status: 'Approved',    amount: 'Rs.30,000',   priority: 'P3' },
  { id: 'BMOC-2024-0031', title: 'Product Ext AdmixtureAD20 SBM Mumbai',customer: 'Internal', type: 'Product Extension',    site: 'INPL003', requestor: 'Priya Sharma',  date: '20 Apr 2026', stage: '—',             status: 'Draft',       amount: 'Rs.70,000',   priority: 'P3' },
  { id: 'BMOC-2024-0030', title: 'New Product ConcreteSeal CS-100',     customer: 'Internal', type: 'Create New Product',   site: 'INPL002', requestor: 'Rahul Verma',   date: '15 Apr 2026', stage: 'Approvals',     status: 'In Progress', amount: 'Rs.3,20,000', priority: 'P2' },
  { id: 'BMOC-2024-0029', title: 'RM Update HRWR Admixture HA-50',      customer: 'Internal', type: 'Raw Material Update',  site: 'INPL005', requestor: 'Vikram Singh',  date: '10 Apr 2026', stage: '—',             status: 'Approved',    amount: 'Rs.65,000',   priority: 'P2' },
  { id: 'BMOC-2024-0028', title: 'Product Update EpoxyCoat EC-200',     customer: 'Internal', type: 'Product Update',       site: 'INPL001', requestor: 'Anjali Mehta',  date: '05 Apr 2026', stage: 'Approvals',     status: 'Rejected',    amount: 'Rs.1,80,000', priority: 'P1' },
  { id: 'BMOC-2024-0027', title: 'New RM GGBS Grade 120',               customer: 'Internal', type: 'New Raw Material',     site: 'INPL004', requestor: 'Rahul Verma',   date: '01 Apr 2026', stage: '—',             status: 'Completed',   amount: 'Rs.4,20,000', priority: 'P3' },
  { id: 'BMOC-2024-0026', title: 'Product Ext RepairMortar RM5 Hyd',    customer: 'Internal', type: 'Product Extension',    site: 'INPL006', requestor: 'Rohit Kumar',   date: '25 Mar 2026', stage: 'Post Approval', status: 'In Progress', amount: 'Rs.90,000',   priority: 'P2' },
];
