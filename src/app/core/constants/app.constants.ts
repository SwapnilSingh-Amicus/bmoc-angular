...
export const WORKFLOW_REQUEST_TYPE_OPTIONS = [
  'Create New Product',
  'Raw Material Update',
  'Product Extension',
  'Product Update',
...
export const PROFIT_CENTERS = [
  ...
  'Membranes',
  'Raw Materials',
  'Worms - Fluid Cracking Catalysts',
  'Worms - Polyolefin Catalysts',
  'LYNX',
  'Skyline',
...
export const SITES = [
  ...
  'LC HPC2 Extrudates',
  'LC HPC2 Solution Makeup',
  'Curtis Bay Hydro Alumina',
  'Curtis Bay Hydro Base / Co-Mull Extrudates',
  'LC HPC1 Extrudates',
  'Columbia FCC R&D Pilot Plant',
  'Columbia Material Technology R&D',
  'Columbia Specialty Catalyst R&D',
  'Chicago 71ST Line 14',
  'Chicago 71ST Line 18',
  'Chicago 71ST Line 19',
  'Columbia FCC R&D',
  'Curtis Bay Process Inovation Center',
  'Curtis Bay Process Inovation Center Pilot Plant',
  'Chicago 71ST Line 13',
  'Chicago 71ST Line 13',
  'Curtis Bay  ART Advanced Refing Technoilogy R&D',
  'CBECAT at Curtis Bay',
  'ART General',
  'ATFCC',
  'LC Alumina 1',
  'LC Alumina 2',
  ...
  'Aiken Plant',
  'ECI Lacassine',
  'Grace GmbH,Belgium Branch',
  'Worms QC',
  'East Chicago, IN (US)',
  'East Chicago Plant',
  'Chattanooga Plant',
  'Worms S&M (DE)-Davison',
  'Chattanooga - ART',
  'EC Colloidal Silica',
  'East Chicago Silicate of Soda',
  'Chattanooga - Raney Cataylst',
  'Chattanooga - Rare Earth FCC',
  'Chattanooga - Washcoats',
  'Chattanooga - Specialty Plant',
  'Chattanooga - Plant Remediation',
  'Chattanooga - Rare Earth/Other',
  'Chattanooga - Rare Earth Process',
  'Chattanooga - FCC Additives',
  'Global Plant',
  'ART LLC - CC 268 KCC',
  'ART LLC -  ACCA Tolling',
  'ART LLC - ACCA',
  'Grace Germany GmbH',
  'GRACE SILICA GmbH',
  'ART GmbH (LP) Worms (DE)',
  'Stenungsund (SE)-Grace Cat. AB',
  'ART (FI)-Davison',
  'ART SrL',
  'Grace GmbH Oddzial (PL)',
  'ADVANCED REFINING TECHNOLOGIES',
  'Grace Hold, S.A. Sucursal (CO)',
  'Grace Santiago (MX)',
  'Grace Brasil Químicos Ltda.',
  'LATAM Warehouses',
  'Grace Hold, S.A. Sucursal (AR)',
  'W. R. Grace Trading (HK)',
  'FICE-SH-Davison-Drx',
  'Grace Corporate Headquarters',
  'Grace Corporate Headquarters',
  'W.R. Grace & Co Holdings',
  'Grace Turkey Kimyevi Madd',
  'GRACE GP GmbH',
  'Grace Management GP GmbH',
  'Grace Netherlands Holding',
  'mertus 366. GmbH',
  'Grace Global Ops Center (PH)',
];
